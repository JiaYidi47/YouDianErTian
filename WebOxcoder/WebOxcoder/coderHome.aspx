...
<body>
    ...
    <!-- 轮播图 -->
    <div style="margin: -20px 0 20px 0;" id="Div1" class="carousel slide" data-ride="carousel">
        <!-- Indicators -->
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="img/code2.png" alt="First slide">
...
-->
        ...
        <div class="row">
            <div class="col-md-8 col-no-left-padding col-md-offset-2">
                ...
                <section class="middle">
                    ...
                    <div style="col-md-6">
                        <form class="input-group">
                            <input name="salary" id="Hidden1" type="hidden" value="0" />
                            <input name="province" id="Hidden2" type="hidden" value="" />
                            <input name="retype" id="Hidden3" type="hidden" value="0" />
                            <input name="flag" id="Hidden4" type="hidden" value="0" />
                            <input name="selectedProvince" id="Hidden5" type="hidden" value="14" />
                            <input name="selectedCity" id="Hidden6" type="hidden" value="1401" />
                            <input name="searchCondition" class="form-control" placeholder="请输入关键词，如公司名称等" value="" />
                            <span class="input-group-btn"><button class="btn"><i class="fa fa-search"></i></button></span>
                        </form>
                    </div>
            ...
            <div class="col-md-4 col-no-left-padding col-md-offset-8" style="margin-top: 20px;">
                <section id="Section5" style="margin-bottom: 20px;">
                    排序： <a href="" class="btn btn-order" id="A1">时间</a> <a href="" class="btn btn-order">热度</a> <a href="" class="btn btn-order">薪资</a>
                </section>
                <!--  排序这边默认什么都不选。默认排序按推荐、热度、时间搞一个算法，推荐一直在最前
                    筛选地区那边默认为用户的期望工作地点 -->
            </div>
    ...
    <!-- /.container -->
    <div class="modal fade" id="Div4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">
                    ...
                    <h4 class="modal-title" id="H1">意见反馈</h4>
                </div>
                <div class="modal-body">
                    <form class="">
                        <textarea class="form-control" placeholder="请输入您的反馈意见" style="min-height: 200px;"></textarea>

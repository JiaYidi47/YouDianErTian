<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="enterpriseSignUp2.aspx.cs" Inherits="WebOxcoder.enterpriseSignUp2" %>
		...
		<div class="row">
			<div class="col-md-6 col-md-push-3 col-xs-10 col-xs-push-1 col-sm-8 col-sm-push-2">
				<div id="content">
					<div class="row">
						<font color="red"></font>
						<form ID="defaultForm" class="form-vertical" runat="server" enctype="multipart/form-data">
							<input id="input-provincework" type="hidden" value="" />
							<input id="input-citywork" type="hidden" value="" />
							<img src="img/corp_step1.png">

							<div class="form-group">
								<label>
									<h3 class="grey">公司全称</h3>
								</label>
								<asp:TextBox runat="server" type="text" ID="corpName2" class="form-control" placeholder="请输入公司全称" />
							</div>
							...
							<div class="form-group">
								...
								<asp:TextBox runat="server" type="text" ID="corpSname" class="form-control" />
							...
							<div class="form-group">
								...
								<asp:FileUpload runat="server" ID="corpLogo" tabindex="-1" style="position: fixed; left: -500px;"  accept="image/*" />
							...
							<div class="form-group">
								...
								<asp:TextBox runat="server" type="text" ID="corpWebsite" class="form-control" />
							...
							<div class="form-group">
								...
								<div id="warp">
									<select runat="server" name="prov" ID="corpProvince" class="form-control" style="width:200px; display:inline-block;">
										<option value="载入中">载入中</option>
									</select>
									<select runat="server" name="city" ID="corpCity" class="form-control" style="width:200px; display:inline-block;">
										<option value="载入中">载入中</option>
									</select>
								</div>
							...
							<div class="form-group">
								...
								<select runat="server" name="corpScale" class="form-control" ID="corpScale">
							...
							<div class="form-group">
								...
								<asp:TextBox runat="server"  ID="corpInfo" rows="9" class="form-control" placeholder="请详细描述公司简介、企业文化等" />
								<span class="help-block" id="hint4" />
							</div>
							<div class="form-group form-actions pull-right">
								<asp:Button runat="server" ID="signup2Button" onClick="signup2Button_Click" class="btn btn-new1 btn-lg" style="border-radius: 3px;" Text="保存&下一步"  />
							</div>
						</form>
					</div>
					<!-- /.row -->

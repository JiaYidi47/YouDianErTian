<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminChangePwd.aspx.cs" Inherits="WebOxcoder.adminChangePwd" %>
                    ...
                    <div class="col-xs-8">
                        <div class="box box-info">
                            ...
                            <div class="box-body">
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="password" class="form-control" placeholder="请重复输入新密码" value="">
                                        </div>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div class="box-footer">
                                <button class="btn btn-info btn-flat pull-right" onclick="window.location.href='adminHome.aspx'">确认</button>
                            </div>
                            <!-- /.box-footer -->
                        </div>
                        <!-- /.box -->

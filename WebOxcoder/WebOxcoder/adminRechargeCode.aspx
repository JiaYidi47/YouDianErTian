<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminRechargeCode.aspx.cs" Inherits="WebOxcoder.adminRechargeCode" %>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview active">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="active"><a href="adminRechargeCode.aspx"><i class="fa fa-circle-o"></i>优惠码</a>
                            </li>
                        </ul>
                    </li>
                </ul>

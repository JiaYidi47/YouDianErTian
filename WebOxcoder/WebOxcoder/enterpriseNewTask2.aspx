<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="enterpriseNewTask2.aspx.cs" Inherits="WebOxcoder.enterpriseNewTask2_unuse_" %>
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown"><a href="javascript:;"
					class="dropdown-toggle" data-toggle="dropdown"><span
						class="text">&#21271;&#20140;&#24066;&#23567;&#28165;&#26032;&#31185;&#25216;&#26377;&#38480;&#20844;&#21496;</span> <b
						class="caret"></b></a>
											...
											<div class="pull-right">
												<div style="display: inline-block; vertical-align: top;">
													<form class="input-group" style="width: 200px"
														action="hr-set-challenge.aspx" method="post">
																			...
																			<div class="row">
																				<div class="col-xs-12">
																					...
																					<div class="pull-right client-info">
																						<a style="color: white"
																							href="enterpriseNewTask3.aspx?flag=new&relevel=<%=level %>&pid=<%# Eval("id") %>&exercise=<%# Eval("id")%>&difficulty=<%# Eval("questionlevel")%>&retype=<%=type%>"
																			class="btn btn-primary btn-sm">添加</a>
																					</div>
																				</div>
																				<!-- /.col-xs-12 -->
																				<div class="col-md-12" style="min-height: 68px;">
																					<ul class="companyTags">                                                                                                              <%# Eval("intro") %>                                                                                                                                                                                                                                           

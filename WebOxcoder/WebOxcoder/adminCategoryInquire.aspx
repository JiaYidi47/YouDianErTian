<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminCategoryInquire.aspx.cs" Inherits="WebOxcoder.adminCategoryInquire" %>
                    ...
                    <li class="treeview active">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="treeview-menu">
                                    <li class="active"><a href="adminCategoryInquire.aspx"><i class="fa fa-circle-o"></i>查询类别</a>
                                    </li>

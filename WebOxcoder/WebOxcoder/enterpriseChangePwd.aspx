<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="enterpriseChangePwd.aspx.cs" Inherits="WebOxcoder.enterpriseChangePwd" %>
                ...
                <div id="content">
                    <div class="row">
                        <form id="defaultForm" class="form-horizontal">
                            ...
                            <button class="btn btn-new1" onclick="window.location.href='enterpriseTask.aspx'">修改密码</button>
                        </form>
                        <!-- 错误信息 -->
                        <font color=red> </font>
                    </div>

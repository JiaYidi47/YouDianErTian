<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="enterpriseInfoChange1.aspx.cs" Inherits="WebOxcoder.enterpriseInfoChange1" %>
        ...
        <div class="row">
            <div class="col-md-6 col-md-push-3 col-xs-10 col-xs-push-1 col-sm-8 col-sm-push-2">
                <div id="content">
                    <div class="row">
                        <font color="red"></font>
                        <form id="defaultForm" class="form-vertical" enctype="multipart/form-data">
                            <input id="input-provincework" type="hidden" value="&#21271;&#20140;" />
                            <input id="input-citywork" type="hidden" value="&#28023;&#28096;&#21306;" /> <img src="img/corp_step1.png">

                            <div class="form-group">
                                <label>
                                    <h3 class="grey">公司全称</h3>
                                </label>
                                <input disabled type="text" id="corp-name" name="cname" class="form-control" placeholder="请输入公司全称" value=".NET&#26377;&#28857;&#20799;&#29980;&#23567;&#32452;">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="corp-sname" name="cnameshort" class="form-control" placeholder="请输入公司简称" value="&#26377;&#28857;&#20799;&#29980;"> <span class="text-danger" id="error1" style="display: none;">请输入公司简称</span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="image" tabindex="-1" style="position: fixed; left: -500px;" id="corp-pic" accept="image/*"> <span class="text-danger" id="error2" style="display: none;">请上传公司logo</span> <span class="help-block" id="hint2"></span>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="" name="website" class="form-control" placeholder="请输入公司网址" value=""> <span class="help-block">非必填</span>
                            </div>
                            <div class="form-group">
                                <label>
                            ...
                            <div class="form-group">
                                ...
                                <select name="scale" class="form-control" id="corp-big">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="corp-info" name="cdes" rows="9" class="form-control" placeholder="请详细描述公司简介、企业文化等">有点儿甜小组
                            ...
                            <div class="form-group pull-right">
                                <button class="btn btn-new1 btn-lg" style="border-radius: 3px;" onclick="window.location.href='enterpriseInfoChange2.aspx'">保存&下一步</button>
                            </div>
                        </form>
                    </div>
                    <!-- /.row -->
